...
{
    public class RoleStore(BankContext bankContext) : IRoleStore<Role>, IQueryableRoleStore<Role>
    {
        private readonly BankContext _context = bankContext ?? throw new ArgumentNullException(nameof(bankContext));
