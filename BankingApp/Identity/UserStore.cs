...
{
    public class UserStore(BankContext context) : IUserStore<User>, IUserPasswordStore<User>, IUserRoleStore<User>, IQueryableUserStore<User>, IUserEmailStore<User>
    {
        private readonly BankContext _context = context ?? throw new ArgumentNullException(nameof(context));
        ...
        public async Task<IList<string>> GetRoleAsync(User user, CancellationToken cancellationToken)
        {
            ...
            var roles = await _context.Set<User>().Include(u => u.Role)
        ...
        {
            cancellationToken.ThrowIfCancellationRequested();
            var userRoles = await _context.Set<User>()
                .Include(u => u.Role)
                .AsNoTracking()
        ...
        public async Task<bool> IsInRoleAsync(User user, string roleName, CancellationToken cancellationToken)
        {
            ...
            var isInRole = await _context.Set<User>().Include(u => u.Role)
                .Where(u => u.Role.Name.ToLower() == roleName.ToLower() && u.Id == user.Id)
        ...
        public async Task RemoveFromRoleAsync(User user, string roleName, CancellationToken cancellationToken)
        {
            ...
            var userRole = _context.Set<User>()
                .Include(u => u.Role)
                .Where(u => u.Role.Name == roleName && u.Id == user.Id);
            _context.Set<User>().RemoveRange(userRole);
            await _context.SaveChangesAsync(cancellationToken);
        }
